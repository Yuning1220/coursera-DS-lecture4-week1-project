...
par(mfrow = c(2, 2))
with(subpower, {
  plot(subpower$Time, as.numeric(subpower$Global_active_power),
       type="l", xlab = "", ylab = "Global Active Power")
  plot(subpower$Time, as.numeric(subpower$Voltage),
       type="l",
  ...
  legend("topright", lty=1,
         ...
         ,cex=0.6)
  plot(subpower$Time, as.numeric(subpower$Global_reactive_power),type="l",
